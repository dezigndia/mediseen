...
const PaymentPharm = (props) => {
  ...
  return (
    ...
    >
      ...
      <div className={classes.divider}></div>
      <Grid style={{ color: "grey", textAlign: "left" }} item xs={12}>
        Details
      </Grid>
      <Grid container item>
        <Grid
...
const mapDispatchToProps = (dispatch) => ({
  setPaymentOption: ({ cod = false, upi = false, bankTransfer = false }) =>
    dispatch(setPaymentOption({ cod, upi, bankTransfer })),
  ...
  setBankAccountNumber: (accountNo) =>
    dispatch(setBankAccountNumber(accountNo)),
