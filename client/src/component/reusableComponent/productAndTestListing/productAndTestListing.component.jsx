	...
	return (
		...
		>
			<div className="vendorTestAndProductListItemHeader">
				<div className="vendorTestAndProductListItemHeaderCount">{qty}KG</div>
			...
			{businessType === "pharmacy" ? (
				<div className="vendorTestAndProductListItemActions">
					{qty === 0 ? (
						<div className="ProductListAddButton">add button</div>
					) : (
						<div className="productListAddRemoveButton">
							...
							<div className="quantityOfProductsLeft">{qty}</div>
